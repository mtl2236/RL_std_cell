...
set TEMPLATE_FILE        ${SRC_DIR}/tcl/template.tcl
set CELLS_FILE           ${RUN_DIR}/tcl/cells.tcl
...
set MODEL_INCLUDE_FILE   ${SRC_DIR}/models/spectre/include
...
#define_leafcell -type nmos -pin_position {0 1 2 3} { enm }
#define_leafcell -type pmos -pin_position {0 1 2 3} { epm }
define_leafcell  -type pmos -pin_position {0 1 2 0} {CNT_CDF}
define_leafcell  -type nmos -pin_position {0 1 2 0} {CNT_CDF_N}
...
## read netlist
set spicefiles {}
foreach cell $cells { lappend spicefiles ${NETLIST_DIR}/${cell}.scs }
...
#write_library -driver_waveform -unique_pin_data -bus_syntax {[]}  -overwrite -filename ${RUN_DIR}/lib/${LIBNAME}_nldm.lib ${LIBNAME}
